...
!(function (t, i) {
    ...
    class i {
        ...
        disable(t = !0) {
            return (
                t === this._disabled ||
                    ((this._disabled = t), this.domElement.classList.toggle('disabled', t), this.$disable.toggleAttribute('disabled', t)),
                this
            );
        }
        show(t = !0) {
        ...
        listen(t = !0) {
            return (
                (this._listening = t),
                void 0 !== this._listenCallbackID && (cancelAnimationFrame(this._listenCallbackID), (this._listenCallbackID = void 0)),
        ...
        return (
            (i = t.match(/(#|0x)?([a-f0-9]{6})/i))
                ...
                : (i = t.match(/rgb\(\s*(\d*)\s*,\s*(\d*)\s*,\s*(\d*)\s*\)/))
                  ...
                  : (i = t.match(/^#?([a-f0-9])([a-f0-9])([a-f0-9])$/i)) && (e = i[1] + i[1] + i[2] + i[2] + i[3] + i[3]),
            !!e && '#' + e
        );
    }
    const n = {
        ...
        o = [{ isPrimitive: !0, match: (t) => 'string' == typeof t, fromHexString: s, toHexString: s }, n, l, r];
    class a extends i {
        constructor(t, i, e, n) {
            var l;
            super(t, i, e, 'color'),
        ...
        constructor(t, i, e) {
            super(t, i, e, 'function'),
                ...
                this.$button.addEventListener('click', (t) => {
                    t.preventDefault(), this.getValue().call(this.object), this._callOnChange();
                }),
        ...
        _initInput() {
            ...
            const o = (t) => {
                    if (r) {
                        const s = t.clientX - i,
                            n = t.clientY - e;
                        Math.abs(n) > 5
                            ? (t.preventDefault(), this.$input.blur(), (r = !1), this._setDraggingStyle(!0, 'vertical'))
                            : Math.abs(s) > 5 && a();
                    }
                    if (!r) {
                        const i = t.clientY - s;
            ...
            this.$input.addEventListener('input', () => {
                ...
                this.$input.addEventListener('keydown', (i) => {
                    'Enter' === i.key && this.$input.blur(),
                        'ArrowUp' === i.code && (i.preventDefault(), t(this._step * this._arrowKeyMultiplier(i))),
                        'ArrowDown' === i.code && (i.preventDefault(), t(this._step * this._arrowKeyMultiplier(i) * -1));
                }),
        ...
        _initSlider() {
                ...
                o = (i) => {
                    if (l) {
                        ...
                        Math.abs(t) > Math.abs(e)
                            ? r(i)
                            : (window.removeEventListener('touchmove', o), window.removeEventListener('touchend', a));
            ...
            this.$slider.addEventListener('mousedown', (s) => {
                ...
                this.$slider.addEventListener(
                    ...
                    (t) => {
                        t.touches.length > 1 ||
                            (this._hasScrollBar ? ((s = t.touches[0].clientX), (n = t.touches[0].clientY), (l = !0)) : r(t),
    ...
    class c extends i {
        ...
        updateDisplay() {
            ...
            return (this.$select.selectedIndex = i), (this.$display.textContent = -1 === i ? t : this._names[i]), this;
        }
    }
    class u extends i {
        constructor(t, i, e) {
    ...
    class g {
        constructor({
            ...
            if (
                ...
                return (
                    this.parent.children.push(this), this.parent.folders.push(this), void this.parent.$children.appendChild(this.domElement)
                );
        ...
        addFolder(t) {
            const i = new g({ parent: this, title: t });
        ...
        _callOnFinishChange(t) {
            this.parent && this.parent._callOnFinishChange(t),
                void 0 !== this._onFinishChange &&
                    this._onFinishChange.call(this, { object: t.object, property: t.property, value: t.getValue(), controller: t });
        }
        onOpenClose(t) {
            return (this._onOpenClose = t), this;
        }
        _callOnOpenClose(t) {
            this.parent && this.parent._callOnOpenClose(t), void 0 !== this._onOpenClose && this._onOpenClose.call(this, t);
        }
        destroy() {
            this.parent &&
                (this.parent.children.splice(this.parent.children.indexOf(this), 1),
    ...
    (t.BooleanController = e),
        (t.ColorController = a),
        (t.Controller = i),
        (t.FunctionController = h),
        (t.GUI = g),
        (t.NumberController = d),
        (t.OptionController = c),
        (t.StringController = u),
        (t.default = g),
